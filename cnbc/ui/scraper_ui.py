...
class ScraperApp:
    def __init__(self, root):
        self.root = root
        self.root.title("CNBC Pro Scraper + Enhancer")
    ...
    def build_ui(self):
        ...
        self.sheet_name_var = tk.StringVar(value="cnbc-authors")
    ...
    def initialize_categories(self):
        """Initialize CNBC categories"""
        self.categories = {
            "Technology": [
                "technology", "cybersecurity", "ai-artificial-intelligence", "enterprise",
                "internet", "media", "mobile", "social-media", "cnbc-disruptors", "tech-guide"
            ],
            "Investing": [
                "investing", "personal-finance", "fintech", "financial-advisors",
                "options-action", "etf-street", "earnings", "trader-talk"
            ],
            "Business": [
                "business", "economy", "finance", "health-and-science", "real-estate",
                "energy", "climate", "transportation", "cnbc-investigations", "industrials",
                "retail", "wealth", "sports", "life"
            ],
            "Markets": [
                "markets", "pre-markets", "us-markets", "markets-europe", "china-markets",
                "markets-asia-pacific", "world-markets", "currencies", "prediction-markets",
                "cryptocurrency", "futures-and-commodities", "bonds", "funds-and-etfs"
            ],
            "Politics": [
                "politics", "white-house", "policy", "defense", "congress",
                "expanding-opportunity", "europe-politics", "china-politics",
...
10. Save settings"""
        ...
        def reset_settings():
            ...
            if result:
                try:
                    ...
                    self.sheet_name_var.set("cnbc-authors")  # Fixed to CNBC default
                    self.json_file_var.set("")
                    self.sheet_name_entry_var.set("cnbc-authors")  # Fixed to CNBC default
    ...
    def scrape_articles(self):
        ...
        # Get categories from config manager (which now has CNBC URLs)
